...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(Source)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(Source)
ZEND_DECLARE_MODULE_GLOBALS(Source)
#define SWIG_ErrorMsg() ZEND_MODULE_GLOBALS_ACCESSOR(Source, error_msg)
#define SWIG_ErrorCode() ZEND_MODULE_GLOBALS_ACCESSOR(Source, error_code)
#ifdef __GNUC__
...
static void Source_init_globals(zend_Source_globals *globals ) {
...
ZEND_NAMED_FUNCTION(_wrap_swig_Source_alter_newobject) {
  zval args[2];
  swig_object_wrapper *value;
...
ZEND_NAMED_FUNCTION(_wrap_swig_Source_get_newobject) {
  zval args[1];
  swig_object_wrapper *value;
...
ZEND_NAMED_FUNCTION(_wrap_add_check_button) {
  ...
  add_check_button(arg1,arg2,arg3);
...
ZEND_NAMED_FUNCTION(_wrap_add_link_button) {
  ...
  add_link_button(arg1,arg2,arg3,arg4);
...
ZEND_NAMED_FUNCTION(_wrap_start) {
  ...
  result = (int)start(arg1,arg2,arg3);
...
static zend_function_entry Source_functions[] = {
 SWIG_ZEND_NAMED_FE(add_button,_wrap_add_button,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(add_check_button,_wrap_add_check_button,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(add_entry,_wrap_add_entry,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(show_message_box,_wrap_show_message_box,swig_arginfo_00)
 SWIG_ZEND_NAMED_FE(add_menu_bar,_wrap_add_menu_bar,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(add_radio,_wrap_add_radio,swig_arginfo_)
 SWIG_ZEND_NAMED_FE(add_link_button,_wrap_add_link_button,swig_arginfo_0000)
 SWIG_ZEND_NAMED_FE(add_switch,_wrap_add_switch,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(add_label,_wrap_add_label,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(add_image,_wrap_add_image,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(start,_wrap_start,swig_arginfo_000)
 SWIG_ZEND_NAMED_FE(swig_Source_alter_newobject,_wrap_swig_Source_alter_newobject,NULL)
 SWIG_ZEND_NAMED_FE(swig_Source_get_newobject,_wrap_swig_Source_get_newobject,NULL)
 ZEND_FE_END
};

/* init section */
zend_module_entry Source_module_entry = {
...
zend_module_entry* SWIG_module_entry = &Source_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &Source_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(Source)
...
SWIG_php_minit {
  ...
  /* oinit subsection */
  ZEND_INIT_MODULE_GLOBALS(Source, Source_init_globals, NULL);
